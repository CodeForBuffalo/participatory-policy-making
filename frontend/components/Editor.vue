        ...
        <b-button-toolbar>
          <b-button-group size="sm" class="mr-1">
            <b-select
              ...
              size="sm"
              @change.native="setFormatValue($event.target.value, commands)"
            >
            </b-select>
          </b-button-group>
          ...
          <b-button-group size="sm" class="mr-1">
            ...
            <b-button :pressed="isActive.italic()" @click="commands.italic">
              <b-icon icon="type-italic" aria-hidden="true" />
            </b-button>

            <b-button :pressed="isActive.strike()" @click="commands.strike">
  ...
  mounted() {
    this.editor = new Editor({
      onUpdate: ({ getHTML, getJSON }) => {
        this.$emit('update:html', getHTML())
        this.$emit('update:json', getJSON())
      },
      extensions: [
        new Blockquote(),
        new HardBreak(),
